...
enum AppCopy {
    ...
    private static let chinese: [String: String] = [
        ...
        "Layout": "布局", "Window arrangement": "窗口布局", "Combined window": "合并窗口", "Separate transcript and translation": "分离原文与翻译", "Text alignment": "文字对齐", "Left": "左", "Center": "居中", "Right": "右", "Confirmed lines per area": "每个区域的已确认行数", "Window controls": "窗口控制", "Lock window and pass clicks through": "锁定窗口并穿透点击", "Reset overlay position and size": "重置悬浮字幕位置和大小",
        ...
        "Waiting": "等待中", "Checking permission": "正在检查权限", "Preparing models": "正在准备模型", "Capturing": "正在录制", "Stopping": "正在停止", "Stopped": "已停止", "Detected:": "检测到：", "Show Overlay": "显示悬浮字幕", "Hide Overlay": "隐藏悬浮字幕", "Lock Overlay": "锁定悬浮字幕", "Unlock Overlay": "解锁悬浮字幕", "Restart Capture": "重新开始录制",
    ...
    private static let japanese: [String: String] = [
        ...
        "Layout": "配置", "Window arrangement": "ウインドウ構成", "Combined window": "1つのウインドウ", "Separate transcript and translation": "原文と翻訳を分離", "Text alignment": "文字揃え", "Left": "左", "Center": "中央", "Right": "右", "Confirmed lines per area": "各領域の確定行数", "Window controls": "ウインドウ操作", "Lock window and pass clicks through": "ウインドウを固定してクリックを透過", "Reset overlay position and size": "位置とサイズをリセット",
        ...
        "Waiting": "待機中", "Checking permission": "権限を確認中", "Preparing models": "モデルを準備中", "Capturing": "キャプチャ中", "Stopping": "停止中", "Stopped": "停止しました", "Detected:": "検出：", "Show Overlay": "オーバーレイを表示", "Hide Overlay": "オーバーレイを隠す", "Lock Overlay": "オーバーレイを固定", "Unlock Overlay": "固定を解除", "Restart Capture": "キャプチャを再開",
        ...
        "Transcription results appear here.": "文字起こし結果がここに表示されます。", "Confirmed translation results appear here.": "確定した翻訳結果がここに表示されます。", "The current translation preview appears here.": "現在の翻訳プレビューがここに表示されます。", "Choose Start from the OST menu bar icon.\nTranscription results appear here.": "メニューバーのOSTアイコンから「開始」を選択してください。\n文字起こし結果がここに表示されます。", "Choose Start from the OST menu bar icon.\nTranslation results appear here.": "メニューバーのOSTアイコンから「開始」を選択してください。\n翻訳結果がここに表示されます。",
    ...
    private static let korean: [String: String] = [
        ...
        "Layout": "배치", "Window arrangement": "창 구성", "Combined window": "한 창에 결합", "Separate transcript and translation": "원문·번역 분리", "Text alignment": "텍스트 정렬", "Left": "좌측", "Center": "가운데", "Right": "우측", "Confirmed lines per area": "영역별 확정 줄 수", "Window controls": "창 조절", "Lock window and pass clicks through": "잠금 및 클릭 통과", "Reset overlay position and size": "오버레이 위치와 크기 초기화",
        ...
        "Waiting": "대기 중", "Checking permission": "권한 확인 중", "Preparing models": "모델 준비 중", "Capturing": "캡처 중", "Stopping": "중지 중", "Stopped": "중지됨", "Detected:": "감지:", "Show Overlay": "오버레이 표시", "Hide Overlay": "오버레이 숨기기", "Lock Overlay": "오버레이 잠금", "Unlock Overlay": "오버레이 잠금 해제", "Restart Capture": "캡처 재시작",
